...
// Hide the loading overlay and show the content
    ...
    var tHeader = gsap.timeline({ })

    tHeader
    .add('head', '+=4')
    .to('.header__masking, .header__paralaxOne', { duration: 0, opacity: 0, display: 'none', ease: "none" }, 'head')
...
// })
  ...
  $(window).scroll(function () {
    ...
    let header_text_black = document.getElementById('header__text_black');
    

    let value = window.scrollY;

      if( !(value >= 820) ) {
        bg_black.style.opacity  = 1 - (value * 0.003);
        planet_black.style.marginLeft  = value * -0.3 + 'px';
        big_island_black.style.marginBottom  = value * 0.16 + 'px';
        small_island_black.style.marginBottom  = value * 0.01 + 'px';
        small_island_left_black.style.marginBottom  = value * 0.05 + 'px';
        middle_island_black.style.marginBottom  = value * 0.05 + 'px';
        planet2_black.style.marginLeft  = value * 0.2 + 'px';
        // color_cloud_black.style.marginLeft  = value * -0.25 + 'px';
        // planet2_black.style.marginBottom  = value * -0.05 + 'px';
        planet2_black.style.transform  = "rotateY(20deg)";
        grass_black.style.marginTop = value * -0.12 + 'px';
        sun_black.style.marginBottom = value * -0.2 + 'px';

        bg.style.opacity  = 1 - (value * 0.003);
